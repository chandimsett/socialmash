  ...
  $.get("ajax/getNotifications.php?status=unread&mode=count", function(data) {
   ...
   $.get("getMessageNotification.php", function(data) {
    $(".messagecount").html(data);
     ...
     $.get("chat/message-listnotification.php", function(data) {
    $(".messagesnotificationpanel").html(data);
  });
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Messages <span class="messagecount"></span><span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <div class="messagesnotificationpanel" style="">            	
            </div>
            <li><a href="#messages?id=0" onClick="loadPage('#messages?id=0')">See All</a></li>
          </ul>
        </li>
      </ul>
...
<div class="chatwindow" style="right:250px;" id="chatwindow-2" data-id="2"><span class="chathead">︽</span><iframe style="left:-13px;position:relative;"src=<?php echo "chat/chatwindow.php?id=0" ?> width="358px"  height="400px" name="floatingchatwindow" frameborder="0"></iframe></div><div class="chatwindow" id="chatwindow-1" data-id="1">︽</div>
